...
DT::datatable(round_all_numeric_values(res_all))
...
DT::datatable(round_all_numeric_values(res_non_exempt))

```

```{r, echo=F}

DT::datatable(round_all_numeric_values(res_exempt))
...
```{r, echo=F}
DT::datatable(round_all_numeric_values(res_industry))
```
